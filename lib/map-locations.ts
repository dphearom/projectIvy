...
export const MAP_LOCATIONS: MapLocation[] = [
  ...
  { name: "Dartmouth",                  region: "USA",        lat: 43.7044,  lng: -72.2887,  category: "advisor" },
  { name: "Northwestern",               region: "USA",        lat: 42.0565,  lng: -87.6753,  category: "advisor" },
  { name: "Georgia State",              region: "USA",        lat: 33.749,   lng: -84.388,   category: "advisor" },
  { name: "Lafayette College",          region: "USA",        lat: 40.6941,  lng: -75.2211,  category: "advisor" },
  { name: "Lehigh",                     region: "USA",        lat: 40.6069,  lng: -75.3786,  category: "advisor" },
  { name: "Babson",                     region: "USA",        lat: 42.2981,  lng: -71.2648,  category: "advisor" },
  { name: "Denison",                    region: "USA",        lat: 40.0714,  lng: -82.5235,  category: "advisor" },
  { name: "Bucknell",                   region: "USA",        lat: 40.9539,  lng: -76.8842,  category: "advisor" },
  { name: "Kenyon College",             region: "USA",        lat: 40.3765,  lng: -82.3963,  category: "advisor" },
  { name: "Taft School",                region: "USA",        lat: 41.6057,  lng: -73.1222,  category: "advisor" },
  { name: "Aiglon College",             region: "Switzerland",lat: 46.305,   lng: 7.045,     category: "advisor" },
  { name: "Asian University for Women", region: "Bangladesh", lat: 22.3569,  lng: 91.7832,   category: "advisor" },
  ...
  { name: "Dartmouth",    region: "USA",       lat: 43.7044,  lng: -72.2887,  category: "destination" },
