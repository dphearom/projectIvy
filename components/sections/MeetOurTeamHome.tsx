            ...
            >
              ...
              <div className="pt-5.5 px-6 pb-5.5">
                <h3 className="text-[1.25rem] text-navy leading-[1.15]">
                  {t(`members.${member.name}.name`, "display")}
                </h3>
                <p className="mt-2 mb-1.5 text-[0.82rem] text-ink-soft leading-[1.45]">
                  {t(`members.${member.name}.school`)}
                </p>
                <p className="text-[0.82rem] font-semibold tracking-[0.08em] uppercase text-gold">
                  {t(`members.${member.name}.role`)}
                </p>
              </div>
            </article>
          ))}
