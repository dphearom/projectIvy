          ...
          {ALL_PROGRAMS.map((program, i) => (
            ...
            >
              ...
              <div className="flex flex-col justify-between p-[28px_30px]">
                <div>
                  <h3 className="text-[1.35rem] text-navy leading-[1.12]">
                    {t(`programs.${program.id}.title`, "display")}
                  </h3>
                  <p className="mt-2.5 text-[0.95rem] text-ink-soft leading-[1.55]">
                    {t(`programs.${program.id}.desc`)}
                  </p>
                </div>
